...
class PolicyReference(BaseModel):
    source: str       # PDF 파일명 또는 URL -> 출처
    page: int         # page 번호
    chapter_info: str # 조항 포함된 장의 subname
    ModDate: str      # 최근 수정 날짜
...
class PolicyQAContent(BaseModel):
    intent: Literal["POLICY_QA"] = "POLICY_QA"
            ...
            "references": [
                {
                    ...
                    "page": 3,
                    "chapter_info": "환불",
                    "ModDate": "D:20250520174935+09'00'"
                }
            ]
        }
    }

    #content = PolicyQAContent.parse_obj(raw["contents"])
    #print(content.references[0].source)  # 제주도
    # for window
    # content = PolicyQAContent.model_validate(raw)
    # print(content.contents.references)
