...
- **진행 기간:** 2025년 3월 ~ 6월
- **팀 구성:** 총 4명 (백엔드 담당: 나)
- **사용 기술:** FastAPI, SQLAlchemy, Pydantic, SQLite, Uvicorn
...
## 🎯 다음 작업 계획
1. `flight.py` 와 `reservation.py` 라우터 CRUD 기능 구현하기.
2. 테스트 데이터 입력 후, 전체 기능 테스트 진행하기.
3. 외부 API 연동 기능 구현하기 (호텔 및 항공 정보 업데이트).
4. 챗봇과의 연동 기능 추가하기.
